...
Dir{1} = PathForExperiments_React_Active_AG({'Tvorozhok'}, 'head-fixed', 'none', '11_10');
Dir{2} = PathForExperiments_React_Active_AG({'Tvorozhok'}, 'head-fixed', 'none', '13_12');
Dir{3} = PathForExperiments_React_Active_AG({'Tvorozhok'}, 'head-fixed', 'none', 'all', 'perf_drop');
